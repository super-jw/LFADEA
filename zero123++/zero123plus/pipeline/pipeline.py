...
class ReferenceOnlyAttnProc(torch.nn.Module):
    ...
    def __call__(
        ...
        mode="w", ref_dict: dict = None, attack_mode=False, is_cfg_guidance = False
    ) -> Any:
...
class RefOnlyNoisedUNet(torch.nn.Module):
    ...
    def forward_cond(self, noisy_cond_lat, timestep, encoder_hidden_states, class_labels, ref_dict, is_cfg_guidance, attack_mode, **kwargs):
        if is_cfg_guidance:
            encoder_hidden_states = encoder_hidden_states[1:]
        ...
        self.unet(
            ...
            cross_attention_kwargs=dict(mode="w", ref_dict=ref_dict, attack_mode=attack_mode),
            **kwargs
        )
    ...
    def forward(
        ...
        **kwargs
        ...
        self.forward_cond(
            ...
            ref_dict, is_cfg_guidance, attack_mode, **kwargs
        )
        if attack_mode:
            return ref_dict
...
class Zero123PlusPipeline(diffusers.StableDiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs
        ...
        self.prepare()
        if image is None and image_1 is None and image_2 is None:
